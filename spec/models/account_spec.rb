...
describe ::Account, type: :model do
  ...
  describe '.get_accounts' do
    let(:mx_response) do
      OpenStruct.new(
        accounts: [
          OpenStruct.new(name: 'Account 1', guid: 'ACT-123', member_guid: 'MBR-123', user_guid:),
          OpenStruct.new(name: 'Account 2', guid: 'ACT-456', member_guid: 'MBR-456', user_guid:)
        ]
      )
    end
      ...
      let(:mx_response) do
        {
          verified_account_numbers: [
            OpenStruct.new(name: 'Account 1', account_guid: 'ACT-123', member_guid: 'MBR-123', user_guid:),
            OpenStruct.new(name: 'Account 2', account_guid: 'ACT-012', member_guid: 'MBR-456', user_guid:)
          ],
          accounts: OpenStruct.new(
            accounts: [
              OpenStruct.new(name: 'Account 1', guid: 'ACT-123', member_guid: 'MBR-123', user_guid:),
              OpenStruct.new(name: 'Account 2', guid: 'ACT-012', member_guid: 'MBR-456', user_guid:)
            ]
          )
        }
      end
